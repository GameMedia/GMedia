						...
						<div class="portlet-body">
							<div class="table-container">
								...
								<tr role="row" class="filter">
									...
									<td>
										<select name="search_icon" id="search_icon" class="form-control form-filter input-sm">
									...
									<td>
										<div class="margin-bottom-5">
											<button class="btn btn-sm yellow filter-submit margin-bottom" onclick="loadPrivilege_Menu()" title="Search"><i class="fa fa-search"></i></button>
