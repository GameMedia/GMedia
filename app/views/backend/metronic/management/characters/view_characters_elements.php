						...
						<div class="portlet-title tabbable-line">
							...
							<div class="actions">
								<select id="colList" multiple="multiple" class="toggle-vis yellow-stripe">
								  ...
								  <option value="2" data-column="2" selected>Timezone</option>
				...
				<div id="formAdd" class="modal fade" tabindex="-1" data-backdrop="static" data-width="400" data-keyboard="false" data-attention-animation="true">
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<form action="javascript:;" id="form_characters_elements" class="form-horizontal">
	...
	<script type="text/javascript" src="assets/js/backend/management/characters/characters_elements.js?<?php echo date("mdH");?>"></script>
	<script type="text/javascript">
		...
		jQuery(document).ready(function() {	
            ...
            FormValidation.init('form_characters_elements', rules);
            
			TableAjax.init("datatable", "characters-management/characters_elements/loadCharacters_Elements");
			UIToastr.init();
