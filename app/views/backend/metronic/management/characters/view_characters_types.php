				...
				<div id="formAdd" class="modal fade" tabindex="-1" data-backdrop="static" data-width="400" data-keyboard="false" data-attention-animation="true">
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<form action="javascript:;" id="form_characters_types" class="form-horizontal">
	...
	<script type="text/javascript" src="assets/js/backend/management/characters/characters_types.js?<?php echo date("mdH");?>"></script>
	<script type="text/javascript">
		...
		jQuery(document).ready(function() {	
            ...
            FormValidation.init('form_characters_types', rules);
            
			TableAjax.init("datatable", "characters-management/characters_types/loadCharacters_Types");
			UIToastr.init();
