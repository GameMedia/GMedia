						...
						<div class="portlet-title tabbable-line">
							...
							<div class="actions">
								<select id="colList" multiple="multiple" class="toggle-vis yellow-stripe">
								  ...
								  <option value="3" data-column="3" selected>File</option>
						...
						<div class="portlet-body">
							<div class="table-container">
								...
								<tr role="row" class="heading">
									...
									<th>Name</th>
									<th class="no-sort" width="80px">File</th>
								...
								<tr role="row" class="filter">
									...
									<td>
										<select name="search_type" id="search_type" data-required="1" class="form-control form-filter input-sm" title="Type">
											...
											<option value="Regulasi International">Regulasi International</option>
											<option value="Regulasi National">Regulasi National</option>
											<option value="Regulasi DPP INSA">Regulasi DPP INSA</option>
										</select>
									</td>
				...
				<div id="formAdd" class="modal fade" tabindex="-1" data-backdrop="static" data-width="400" data-keyboard="false" data-attention-animation="true">
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<form action="javascript:;" id="form_regulasi" class="form-horizontal">
									...
									<div class="form-group">
									  ...
									  <div class="col-md-9">
										<div class="input-icon right">
											...
											<select name="type" id="type" data-required="1" class="form-control" title="Type Regulasi" placeholder="Type Regulasi">
												<option value="">- Choose Type Regulasi -</option>
												<option value="Buletin">Buletin</option>
												<option value="Regulasi International">Regulasi International</option>
												<option value="Regulasi National">Regulasi National</option>
												<option value="Regulasi DPP INSA">Regulasi DPP INSA</option>
	...
	<script type="text/javascript" src="assets/js/backend/management/content/regulasi.js?<?php echo date("mdH");?>"></script>
	<script type="text/javascript">
		...
		jQuery(document).ready(function() {	
            ...
            FormValidation.init('form_regulasi', rules);
            
			TableAjax.init("datatable", "content-management/regulasi/loadRegulasi");
			UIToastr.init();
