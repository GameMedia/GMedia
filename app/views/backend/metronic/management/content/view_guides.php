						...
						<div class="portlet-body">
							<div class="table-container">
								...
								<tr role="row" class="filter">
									<td></td>
									<td>
										<select name="search_id_game" id="search_id_game" data-required="1" class="form-control form-filter input-sm" title="Type">
				...
				<div class="col-md-12 column sortable" id="view-content" style="display:none">
					<div class="portlet portlet-sortable light bordered">
						...
						<div class="portlet-body">
							<div class="table-container">
								<form action="javascript:;" id="form_guides" class="form-horizontal">
										...
										<div class="form-group">
										  ...
										  <div class="col-md-10">
											<div class="input-icon right">
												...
												<select name="id_game" id="id_game" data-required="1" class="form-control" title="Type">
													<option value="">- Game -</option>
													<?php foreach($games['rows'] as $key){ ?>
													<option value="<?php echo $key['id'];?>"><?php echo $key['name'];?></option>
													<?php } ?>
	...
	<script type="text/javascript" src="assets/js/backend/management/content/guides.js?<?php echo date("mdH");?>"></script>
	<script type="text/javascript">
		...
		jQuery(document).ready(function() {	
            ...
            FormValidation.init('form_guides', rules);
            
			TableAjax.init("datatable", "content-management/guides/loadGuides");
			UIToastr.init();
			...
			$(function(){
			  ...
			  $('#cke_1_guides').css({ height: ($(window).innerHeight()-340) });
