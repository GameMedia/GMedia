						...
						<div class="portlet-title tabbable-line">
							...
							<div class="actions">
								<select id="colList" multiple="multiple" class="toggle-vis yellow-stripe">
								  ...
								  <option value="2" data-column="2" selected>Position</option>
						...
						<div class="portlet-body">
							<div class="table-container">
								...
								<tr role="row" class="filter">
									...
									<td><input type="text" class="form-control form-filter input-sm" id="search_position" name="search_position" placeholder="Search by Position"></td>
									<td></td>
									<td>
				...
				<div id="formAdd" class="modal fade" tabindex="-1" data-backdrop="static" data-width="400" data-keyboard="false" data-attention-animation="true">
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<form action="javascript:;" id="form_management_team" class="form-horizontal">
								<div class="modal-body">
									...
									<div class="form-group">
									  ...
									  <div class="col-md-9">
										<div class="input-icon right">
											...
											<input type="text" maxlength="50" name="position" id="position" data-required="1" class="form-control" title="Position" placeholder="Position" />
										</div>
									  </div>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
									  ...
									  <div class="col-md-3">
										<div class="input-icon right">
											<i class="fa fa-exclamation tooltips" data-original-title="please write a Sequence" data-container="body"></i>
											<input type="text" maxlength="3" name="sequence" id="sequence" data-required="1" class="form-control" title="Sequence" placeholder="Sequence" />
										</div>
									  </div>
									</div>
									<div class="form-group">
	...
	<script type="text/javascript" src="assets/js/backend/management/content/management_team.js?<?php echo date("mdH");?>"></script>
	<script type="text/javascript">
		...
		jQuery(document).ready(function() {	
            ...
            FormValidation.init('form_management_team', rules);
            
			TableAjax.init("datatable", "content-management/management_team/loadManagement_Team");
			UIToastr.init();
