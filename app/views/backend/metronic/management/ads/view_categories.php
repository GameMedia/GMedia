						...
						<div class="portlet-title tabbable-line">
							...
							<div class="actions">
								<select id="colList" multiple="multiple" class="toggle-vis yellow-stripe">
								  ...
								  <option value="3" data-column="3" selected>Position</option>
								  <option value="4" data-column="4" selected>Width x Height</option>
						...
						<div class="portlet-body">
							<div class="table-container">
								...
								<tr role="row" class="heading">
									...
									<th class="no-sort" width="100px">Width x Height</th>
									<th width="70px">is Active?</th>
									<th  class="no-sort"width="100px">Actions</th>
								</tr>
								<tr role="row" class="filter">
									<td></td>
									<td><input type="text" class="form-control form-filter input-sm" id="search_code" name="search_code" placeholder="Search by Code"></td>
									<td><input type="text" class="form-control form-filter input-sm" id="search_name" name="search_name" placeholder="Search by Name"></td>
									<td>
										<select class="form-control form-filter input-sm" id="search_position" name="search_position" title="Search by Position">
				...
				<div id="formAdd" class="modal fade" tabindex="-1" data-backdrop="static" data-width="400" data-keyboard="false" data-attention-animation="true">
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<form action="javascript:;" id="form_categories" class="form-horizontal">
								<div class="modal-body">
									...
									<div class="form-group">
									  ...
									  <div class="col-md-9">
										<div class="input-icon right">
											...
											<input type="text" maxlength="255" name="code" id="code" data-required="1" class="form-control" title="Code" placeholder="Code" />
										</div>
									  </div>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
									  ...
									  <div class="col-md-4">
										<div class="input-icon right">
											<i class="fa fa-exclamation tooltips" data-original-title="please write a height" data-container="body"></i>
											<input type="text" maxlength="4" name="width" id="width" class="form-control form-filter" title="Width" placeholder="Width">
										</div>
									  </div>
									  <div class="col-md-1"> <center>X</center> </div>
									  <div class="col-md-4">
										<div class="input-icon right">
											<i class="fa fa-exclamation tooltips" data-original-title="please write a height" data-container="body"></i>
											<input type="text" maxlength="4" name="height" id="height" class="form-control form-filter" title="Height" placeholder="Height">
										</div>
									  </div>
									</div>									
									<div class="form-group">
	...
	<script type="text/javascript" src="assets/js/backend/management/ads/categories.js?<?php echo date("mdH");?>"></script>
	<script type="text/javascript">
		...
		jQuery(document).ready(function() {	
            ...
            FormValidation.init('form_categories', rules);
            
			TableAjax.init("datatable", "ads-management/categories/loadCategories");
			UIToastr.init();
