						...
						<div class="portlet-title tabbable-line">
							...
							<div class="actions">
								<select id="colList" multiple="multiple" class="toggle-vis yellow-stripe">
								  ...
								  <option value="1" data-column="1" selected>Content Type</option>
										...
										<div class="form-group">
										  ...
										  <div class="col-md-10">
											<div class="input-icon right">
												...
												<select name="id_website" id="id_website" data-required="1" class="form-control" title="Website">
													<option value="">- Choose Website -</option>
													<?php foreach($websites['rows'] as $key){ ?>
													<option value="<?php echo $key['id'];?>"><?php echo $key['name'];?></option>
													<?php } ?>
												</select>
											</div>
