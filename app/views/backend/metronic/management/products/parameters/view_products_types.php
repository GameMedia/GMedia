				...
				<div id="formAdd" class="modal fade" tabindex="-1" data-backdrop="static" data-width="400" data-keyboard="false" data-attention-animation="true">
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<form action="javascript:;" id="form_products_types" class="form-horizontal">
									...
									<div class="form-group">
									  ...
									  <div class="col-md-9">
										<div class="input-icon right">
											...
											<input type="text" maxlength="25" name="code" id="code" class="form-control form-filter" title="Code" placeholder="Code">
										</div>
									  </div>
									</div>
									<div class="form-group">
	...
	<script type="text/javascript" src="assets/js/backend/management/products/parameters/products_types.js?<?php echo date("mdH");?>"></script>
	<script type="text/javascript">
		...
		jQuery(document).ready(function() {	
            ...
            FormValidation.init('form_products_types', rules);
            
			TableAjax.init("datatable", "product-management/products_types/loadProducts_Types");
			UIToastr.init();
