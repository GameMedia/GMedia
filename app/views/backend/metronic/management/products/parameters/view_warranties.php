				...
				<div id="formAdd" class="modal fade" tabindex="-1" data-backdrop="static" data-width="400" data-keyboard="false" data-attention-animation="true">
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<form action="javascript:;" id="form_warranties" class="form-horizontal">
								<div class="modal-body">
									...
									<div class="form-group">
									  ...
									  <div class="col-md-9">
										<div class="input-icon right">
											<i class="fa fa-exclamation tooltips" data-original-title="please write a display" data-container="body"></i>
											<input type="text" maxlength="25" name="display" id="display" class="form-control form-filter" title="Display Warranties" placeholder="Display Warranties">
										</div>
									  </div>
									</div>
	...
	<script type="text/javascript" src="assets/js/backend/management/products/parameters/warranties.js?<?php echo date("mdH");?>"></script>
	<script type="text/javascript">
		...
		jQuery(document).ready(function() {	
            ...
            FormValidation.init('form_warranties', rules);
            
			TableAjax.init("datatable", "product-management/warranties/loadWarranties");
			UIToastr.init();
