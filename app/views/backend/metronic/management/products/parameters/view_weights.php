				...
				<div id="formAdd" class="modal fade" tabindex="-1" data-backdrop="static" data-width="400" data-keyboard="false" data-attention-animation="true">
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<form action="javascript:;" id="form_weights" class="form-horizontal">
									...
									<div class="form-group">
									  ...
									  <div class="col-md-9">
										<div class="input-icon right">
											...
											<input type="text" maxlength="25" name="display" id="display" class="form-control form-filter" title="Display Weight" placeholder="Display Weight">
										</div>
									  </div>
									</div>
	...
	<script type="text/javascript" src="assets/js/backend/management/products/parameters/weights.js?<?php echo date("mdH");?>"></script>
	<script type="text/javascript">
		...
		jQuery(document).ready(function() {	
            ...
            FormValidation.init('form_weights', rules);
            
			TableAjax.init("datatable", "product-management/weights/loadWeights");
			UIToastr.init();
