						...
						<div class="portlet-body">
							<div class="table-container">
								...
								<tr role="row" class="filter">
									...
									<td><input type="text" class="form-control form-filter input-sm" id="search_parent" name="search_parent" placeholder="Search by Parent"></td> <!-- parent -->
									<td><select name="search_id_country" id="search_id_country" data-required="1" class="form-control form-filter input-sm" title="Country">
											...
											<option value="<?php echo $key['id'];?>"><?php echo $key['code'];?></option>
											<?php } ?>
