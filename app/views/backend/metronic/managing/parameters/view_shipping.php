						...
						<div class="portlet-title tabbable-line">
							...
							<div class="actions">
								<select id="colList" multiple="multiple" class="toggle-vis yellow-stripe">
								  ...
								  <option value="1" data-column="1" selected>State</option>
								  <option value="2" data-column="2" selected>Price</option>
								  <option value="3" data-column="3" selected>ETD</option>
						...
						<div class="portlet-body">
							<div class="table-container">
								...
								<tr role="row" class="filter">
									<td></td>
									<td>
										<select class="form-control form-filter input-sm" id="search_id_state" name="search_id_state">
											<option value="">- Choose State -</option>
											<?php 
											foreach($states['rows'] as $key){
											?>
											<option value="<?php echo $key['id'];?>"><?php echo $key['name'];?></option>
											<?php } ?>
										</select>
									</td>
									<td><input type="text" class="form-control form-filter input-sm" id="search_price" name="search_price" placeholder="Search by Price"></td>
									<td><input type="text" class="form-control form-filter input-sm" id="search_etd" name="search_etd" placeholder="Search by ETD"></td>
									<td>
				...
				<div id="formAdd" class="modal fade" tabindex="-1" data-backdrop="static" data-width="400" data-keyboard="false" data-attention-animation="true">
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<form action="javascript:;" id="form_shipping" class="form-horizontal">
								<div class="modal-body">
									...
									<div class="form-group">
									  ...
									  <div class="col-md-9">
										<div class="input-icon right">
											<i class="fa fa-exclamation tooltips" data-original-title="please write a price" data-container="body"></i>
											<input type="text" maxlength="11" name="price" id="price" data-required="1" class="form-control" title="Price" placeholder="Price" />
										</div>
									  </div>
									</div>
									<div class="form-group">
									  <label  class="col-md-3 control-label">Estimation Delivery</label>
									  <div class="col-md-9">
										<div class="input-icon right">
											<input type="text" maxlength="255" name="etd" id="etd" class="form-control form-filter" title="Estimation Delivery" placeholder="Estimation Delivery">
										</div>
									  </div>
									</div>
									<div class="form-group">
	...
	<script type="text/javascript" src="assets/js/backend/managing/parameters/shipping.js?<?php echo date("mdH");?>"></script>
	<script type="text/javascript">
		...
		jQuery(document).ready(function() {	
            ...
            FormValidation.init('form_shipping', rules);
            
			TableAjax.init("datatable", "managing-parameters/shipping/loadShipping");
			UIToastr.init();
