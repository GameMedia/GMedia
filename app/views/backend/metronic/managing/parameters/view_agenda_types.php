				...
				<div id="formAdd" class="modal fade" tabindex="-1" data-backdrop="static" data-width="400" data-keyboard="false" data-attention-animation="true">
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<form action="javascript:;" id="form_agenda_types" class="form-horizontal">
									...
									<div class="form-group">
									  ...
									  <div class="col-md-9">
										<div class="input-icon right">
											<i class="fa fa-exclamation tooltips" data-original-title="please write a agenda type code" data-container="body"></i>
											<input type="text" maxlength="25" name="code" id="code" class="form-control form-filter" title="Agenda Type Code" placeholder="Agenda Type Code">
										</div>
									  </div>
									</div>
									<div class="form-group">
	...
	<script type="text/javascript" src="assets/js/backend/managing/parameters/agenda_types.js?<?php echo date("mdH");?>"></script>
	<script type="text/javascript">
		...
		jQuery(document).ready(function() {	
            ...
            FormValidation.init('form_agenda_types', rules);
            
			TableAjax.init("datatable", "managing-parameters/agenda_types/loadAgenda_Types");
			UIToastr.init();
