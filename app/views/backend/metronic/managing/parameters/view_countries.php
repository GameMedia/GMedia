	...
	<script type="text/javascript" src="assets/js/backend/managing/parameters/countries.js?<?php echo date("mdH");?>"></script>
	<script type="text/javascript">
		...
		jQuery(document).ready(function() {	
			...
			TableAjax.init("datatable", "managing-parameters/countries/loadCountries");
			UIToastr.init();
