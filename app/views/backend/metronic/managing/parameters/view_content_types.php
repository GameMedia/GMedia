	...
	<script type="text/javascript" src="assets/js/backend/managing/parameters/content_types.js?<?php echo date("mdH");?>"></script>
	<script type="text/javascript">
		...
		jQuery(document).ready(function() {	
			...
			TableAjax.init("datatable", "managing-parameters/content_types/loadContent_Types");
			UIToastr.init();
