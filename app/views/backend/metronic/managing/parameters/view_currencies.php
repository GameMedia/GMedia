						...
						<div class="portlet-title tabbable-line">
							...
							<div class="actions">
								<select id="colList" multiple="multiple" class="toggle-vis yellow-stripe">
								  ...
								  <option value="4" data-column="4" selected>Display</option>
						...
						<div class="portlet-body">
							<div class="table-container">
								...
								<tr role="row" class="filter">
									...
									<td><input type="text" class="form-control form-filter input-sm" id="search_display" name="search_display" placeholder="Search by Display"></td>
									<td>
				...
				<div id="formAdd" class="modal fade" tabindex="-1" data-backdrop="static" data-width="400" data-keyboard="false" data-attention-animation="true">
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<form action="javascript:;" id="form_currencies" class="form-horizontal">
								<div class="modal-body">
									...
									<div class="form-group">
									  ...
									  <div class="col-md-9">
										<div class="input-icon right">
											...
											<input type="text" maxlength="25" name="code" id="code" class="form-control form-filter" title="Country Code" placeholder="Country Code">
										</div>
									  </div>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
									  ...
									  <div class="col-md-9">
										<div class="input-icon right">
											<input type="text" maxlength="10" name="display" id="display" class="form-control form-filter" title="Description" placeholder="Display">
										</div>
									  </div>
									</div>
									<div class="form-group">
	...
	<script type="text/javascript" src="assets/js/backend/managing/parameters/currencies.js?<?php echo date("mdH");?>"></script>
	<script type="text/javascript">
		...
		jQuery(document).ready(function() {	
            ...
            FormValidation.init('form_currencies', rules);
            
			TableAjax.init("datatable", "managing-parameters/currencies/loadCurrencies");
			UIToastr.init();
