				...
				<div id="formAdd" class="modal fade" tabindex="-1" data-backdrop="static" data-width="400" data-keyboard="false" data-attention-animation="true">
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<form action="javascript:;" id="form_positions" class="form-horizontal">
	...
	<script type="text/javascript" src="assets/js/backend/managing/masters/positions.js?<?php echo date("mdH");?>"></script>
	<script type="text/javascript">
		...
		jQuery(document).ready(function() {	
            ...
            FormValidation.init('form_positions', rules);
            
			TableAjax.init("datatable", "managing-masters/positions/loadPositions");
			UIToastr.init();
