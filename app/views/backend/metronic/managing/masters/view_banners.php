				...
				<div id="formAdd" class="modal fade" tabindex="-1" data-backdrop="static" data-width="400" data-keyboard="false" data-attention-animation="true">
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<form action="javascript:;" id="form_banners" class="form-horizontal">
								<div class="modal-body">
									...
									<div class="form-group">
									  ...
									  <div class="col-md-9">
										<div class="input-icon right">
											<i class="fa fa-exclamation tooltips" data-original-title="please choose a type" data-container="body"></i>
											<select name="type" id="type" data-required="1" class="form-control" title="Type" onchange="checkType(this.value)">
									...
									<div class="form-group" id="type-video" style="display:none">
									  <label  class="col-md-3 control-label">Video URL</label>
									  <div class="col-md-9">
										<div class="input-icon right">
											<i class="fa fa-exclamation tooltips" data-original-title="please write a video url" data-container="body"></i>
											<input type="text" maxlength="255" name="video" id="video" data-required="1" class="form-control" title="Video URL" placeholder="Video Url" />
										</div>
									  </div>
									</div>
									<div class="form-group" id="type-image" style="display:none">
									  ...
									  <div class="col-md-9">
										<div class="input-icon right">
											...
											<span class="help-block">Image Size 1170 x 413 pixel</span>									
	...
	<script type="text/javascript" src="assets/js/backend/managing/masters/banners.js?<?php echo date("mdH");?>"></script>
	<script type="text/javascript">
		...
		jQuery(document).ready(function() {	
            ...
            FormValidation.init('form_banners', rules);
            
			TableAjax.init("datatable", "managing-masters/banners/loadBanners");
			UIToastr.init();
