	...
	<script type="text/javascript" src="assets/js/backend/managing/masters/galleries.js?<?php echo date("mdH");?>"></script>
	<script type="text/javascript">
		...
		jQuery(document).ready(function() {	
			...
			TableAjax.init("datatable", "managing-masters/galleries/loadGalleries");
			UIToastr.init();
