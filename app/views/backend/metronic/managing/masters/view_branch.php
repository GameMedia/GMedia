						...
						<div class="portlet-title tabbable-line">
							...
							<div class="actions">
								<select id="colList" multiple="multiple" class="toggle-vis yellow-stripe">
								  ...
								  <option value="2" data-column="2" selected>Phone</option>
								  <option value="3" data-column="3" selected>Fax</option>
						...
						<div class="portlet-body">
							<div class="table-container">
								...
								<tr role="row" class="filter">
									...
									<td><input type="text" class="form-control form-filter input-sm" id="search_fax" name="search_fax" placeholder="Search by Fax"></td>
				...
				<div id="formAdd" class="modal fade" tabindex="-1" data-backdrop="static" data-width="400" data-keyboard="false" data-attention-animation="true">
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<form action="javascript:;" id="form_branch" class="form-horizontal">
									...
									<div class="form-group">
									  ...
									  <div class="col-md-9">
										<div class="input-icon right">
											...
											<textarea maxlength="255" name="address" id="address" data-required="1" class="form-control" title="Address" placeholder="Address"></textarea>
										</div>
									  </div>
									</div>
									<div class="form-group">
									  ...
									  <div class="col-md-9">
										<div class="input-icon right">
											...
											<input type="text" maxlength="25" name="phone" id="phone" class="form-control form-filter" title="Phone" placeholder="Phone">
										</div>
									  </div>
									</div>
									<div class="form-group">
									  ...
									  <div class="col-md-9">
										<div class="input-icon right">
											...
											<input type="text" maxlength="25" name="fax" id="fax" class="form-control form-filter" title="Fax" placeholder="Fax">
										</div>
									  </div>
									</div>									
									<div class="form-group">
									  ...
									  <div class="col-md-9">
										<div class="input-icon right">
											...
											<input type="text" maxlength="255" name="email" id="email" class="form-control form-filter" title="E-mail" placeholder="E-mail">
										</div>
									  </div>
									</div>									
									<div class="form-group">
	...
	<script type="text/javascript" src="assets/js/backend/managing/masters/branch.js?<?php echo date("mdH");?>"></script>
	<script type="text/javascript">
		...
		jQuery(document).ready(function() {	
            ...
            FormValidation.init('form_branch', rules);
            
			TableAjax.init("datatable", "managing-masters/branch/loadBranch");
			UIToastr.init();
