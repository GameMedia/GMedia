function view(id){
	...
	jQuery.ajax({
			url:  domain+"managing-parameters/agenda_types/getAgenda_TypesData",
			dataType: "json",
			type: "POST",
			data: {
					'id' : id
				  },
			beforeSend: loadingShow('#form_agenda_types'),
...
function save(){
	...
	var form = $('#form_agenda_types');
	var error = $('.alert-error-save', form);
    var success = $('.alert-success-save', form);
		
	jQuery.ajax({
			url:  domain+"managing-parameters/agenda_types/saveAgenda_Types",
			dataType: "json",
			type: "POST",
			data: {
					'id' : id,
