function view(id){
	...
	jQuery.ajax({
			url:  domain+"managing-masters/business_fields/getBusiness_FieldsData",
			dataType: "json",
			type: "POST",
			data: {
					'id' : id
				  },
			beforeSend: loadingShow('#form_business_fields'),
			success: function(data) {
										...
										loadingHide('#form_business_fields');
									}
		   });	
}
...
function save(){
	...
	var form = $('#form_business_fields');
	var error = $('.alert-error-save', form);
    var success = $('.alert-success-save', form);
		
	jQuery.ajax({
			url:  domain+"managing-masters/business_fields/saveBusiness_Fields",
			dataType: "json",
			type: "POST",
			data: {
					'id' : id,
