function view(id){
	...
	jQuery.ajax({
			url:  domain+"managing-masters/positions/getPositionsData",
			dataType: "json",
			type: "POST",
			data: {
					'id' : id
				  },
			beforeSend: loadingShow('#form_positions'),
...
function save(){
	...
	var form = $('#form_positions');
	var error = $('.alert-error-save', form);
    var success = $('.alert-success-save', form);
		
	jQuery.ajax({
			url:  domain+"managing-masters/positions/savePositions",
			dataType: "json",
			type: "POST",
			data: {
					'id' : id,
