function view(id){
	...
	jQuery.ajax({
			url:  domain+"managing-masters/ship_types/getShip_TypesData",
			dataType: "json",
			type: "POST",
			data: {
					'id' : id
				  },
			beforeSend: loadingShow('#form_ship_types'),
...
function save(){
	...
	var form = $('#form_ship_types');
	var error = $('.alert-error-save', form);
    var success = $('.alert-success-save', form);
		
	jQuery.ajax({
			url:  domain+"managing-masters/ship_types/saveShip_Types",
			dataType: "json",
			type: "POST",
			data: {
					'id' : id,
