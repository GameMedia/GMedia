function view(id){
	...
	jQuery.ajax({
			url:  domain+"product-management/Weights/getWeightsData",
			dataType: "json",
			type: "POST",
			data: {
					'id' : id
				  },
			beforeSend: loadingShow('#form_weights'),
...
function save(){
	...
	jQuery.ajax({
			url:  domain+"product-management/weights/saveWeights",
			dataType: "json",
			type: "POST",
			data: {
					'id' : id,
