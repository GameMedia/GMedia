function view(id){
	...
	jQuery.ajax({
			url:  domain+"product-management/Products_Types/getProducts_TypesData",
			dataType: "json",
			type: "POST",
			data: {
					'id' : id
				  },
			beforeSend: loadingShow('#form_products_types'),
			success: function(data) {
										...
										loadingHide('#form_products_types');
									}
		   });	
}
...
function save(){
	...
	var form = $('#form_products_types');
	var error = $('.alert-error-save', form);
    var success = $('.alert-success-save', form);
		
	jQuery.ajax({
			url:  domain+"product-management/products_types/saveProducts_Types",
			dataType: "json",
			type: "POST",
			data: {
					'id' : id,
