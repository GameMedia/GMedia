function view(id){
	...
	jQuery.ajax({
			url:  domain+"content-management/guides/getGuidesData",
			dataType: "json",
			type: "POST",
			data: {
					'id' : id
				  },
			beforeSend: loadingShow('#form_guides'),
...
function save(){
	...
	var form = $('#form_guides');
	var error = $('.alert-error-save', form);
    var success = $('.alert-success-save', form);
		
	jQuery.ajax({
			url:  domain+"content-management/guides/saveGuides",
			dataType: "json",
			type: "POST",
			data: {
					'id' : id,
