function view(id){
	...
	jQuery.ajax({
			url:  domain+"characters-management/characters_grades/getCharacters_GradesData",
			dataType: "json",
			type: "POST",
			data: {
					'id' : id
				  },
			beforeSend: loadingShow('#form_characters_grades'),
			success: function(data) {
										...
										loadingHide('#form_characters_grades');
									}
		   });	
}
...
function save(){
	...
	var form = $('#form_characters_grades');
	var error = $('.alert-error-save', form);
    var success = $('.alert-success-save', form);
		
	jQuery.ajax({
			url:  domain+"characters-management/characters_grades/saveCharacters_Grades",
			dataType: "json",
			type: "POST",
			data: {
					'id' : id,
