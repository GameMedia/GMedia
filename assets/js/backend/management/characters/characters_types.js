function view(id){
	...
	jQuery.ajax({
			url:  domain+"characters-management/characters_types/getCharacters_TypesData",
			dataType: "json",
			type: "POST",
			data: {
					'id' : id
				  },
			beforeSend: loadingShow('#form_characters_types'),
			success: function(data) {
										...
										loadingHide('#form_characters_types');
									}
		   });	
}
...
function save(){
	...
	var form = $('#form_characters_types');
	var error = $('.alert-error-save', form);
    var success = $('.alert-success-save', form);
		
	jQuery.ajax({
			url:  domain+"characters-management/characters_types/saveCharacters_Types",
			dataType: "json",
			type: "POST",
			data: {
					'id' : id,
