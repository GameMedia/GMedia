function view(id){
	...
	jQuery.ajax({
			url:  domain+"characters-management/characters_elements/getCharacters_ElementsData",
			dataType: "json",
			type: "POST",
			data: {
					'id' : id
				  },
			beforeSend: loadingShow('#form_characters_elements'),
			success: function(data) {
										...
										loadingHide('#form_characters_elements');
									}
		   });	
}
...
function save(){
	...
	var form = $('#form_characters_elements');
	var error = $('.alert-error-save', form);
    var success = $('.alert-success-save', form);
		
	jQuery.ajax({
			url:  domain+"characters-management/characters_elements/saveCharacters_Elements",
			dataType: "json",
			type: "POST",
			data: {
					'id' : id,
